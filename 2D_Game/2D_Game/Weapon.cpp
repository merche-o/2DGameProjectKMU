...
Weapon::Weapon(int Damage, float FireRate, int Range, int Speed, int NumPlayer, Item::itemType WeaponType)
	: ammo(20), damage(Damage), fireRate(FireRate), range(Range), speed(Speed), numPlayer(NumPlayer), type(WeaponType)
{
...
Weapon::Weapon(int Damage, float FireRate, int Range, int Speed)
	: ammo(20), damage(Damage), fireRate(FireRate), range(Range), speed(Speed)
{
}
